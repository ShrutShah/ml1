...
def Contri():
   tkinter.messagebox.showinfo("Contributors","Shrut Shah")
...
class PageTwo(tk.Frame):
    def __init__(self, master):
        ...
        def cam():
            ...
            print("UID:"+ uid)
            os.system('python drowsiness_yawn.py -uid '+uid+' -w 0')
        ...
        def report():
            ...
            s.login("sdhah1999@gmail.com","occwodztdagkwwal")
            s.ehlo()
